  ...
  SimpleSlider = (function() {
    ...
    function SimpleSlider(input, options) {
      ...
      this.track.on('touchstart mousedown', function(e) {
        ...
        _this.domDrag(e, e.pageX, e.pageY, true);
      ...
      this.dragger.on('touchstart mousedown', function(e) {
        ...
        _this.domDrag(e, e.pageX, e.pageY);
        return false;
      });
      //////////
    ...
    SimpleSlider.prototype.trackEvent = function(e) {
      ...
      this.domDrag(e, e.pageX, e.pageY, true);
      this.dragging = true;
      return false;
    };

    SimpleSlider.prototype.domDrag = function(e, pageX, pageY, animate) {
      ...
      if (e.originalEvent && e.originalEvent.touches) {
        ...
        _ref1 = e.touches[0], pageX = _ref1.pageX, pageY = _ref1.pageY;
      } 
      else {
